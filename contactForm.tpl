...
<form class="pkp_form" id="contactForm" method="post" action="{url op="saveContact"}">
	...
	{fbvFormSection}
		...
		{fbvElement type="email" label="Email privé 1" id="email_private_1" name="email_private_1" value=$email_private_1 size=$fbvStyles.size.MEDIUM}
		{fbvElement type="email" label="Email privé 2" id="email_private_2" name="email_private_2" value=$email_private_2 size=$fbvStyles.size.MEDIUM}
