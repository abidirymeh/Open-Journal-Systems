...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_689120560db8e2_87373136',
...
function content_689120560db8e2_87373136 (Smarty_Internal_Template $_smarty_tpl) {
$_block_plugin1 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0] : null;
...
$_block_repeat=true;
echo $_block_plugin1(array('id'=>"userGroups",'title'=>"user.roles",'class'=>'border'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin2(array('label'=>$_smarty_tpl->tpl_vars['userGroupSectionLabel']->value,'translate'=>false,'list'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo $_block_plugin2(array('label'=>$_smarty_tpl->tpl_vars['userGroupSectionLabel']->value,'translate'=>false,'list'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin3(array('title'=>$_smarty_tpl->tpl_vars['context']->value->getLocalizedName(),'list'=>true,'translate'=>false), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
?>
				<?php $_block_repeat=false;
echo $_block_plugin3(array('title'=>$_smarty_tpl->tpl_vars['context']->value->getLocalizedName(),'list'=>true,'translate'=>false), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
				<?php }?>
			<?php
...
$_block_repeat=true;
echo $_block_plugin5(array('for'=>"interests"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
	...
	<?php $_block_repeat=false;
echo $_block_plugin5(array('for'=>"interests"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
$_block_repeat=false;
echo $_block_plugin1(array('id'=>"userGroups",'title'=>"user.roles",'class'=>'border'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
