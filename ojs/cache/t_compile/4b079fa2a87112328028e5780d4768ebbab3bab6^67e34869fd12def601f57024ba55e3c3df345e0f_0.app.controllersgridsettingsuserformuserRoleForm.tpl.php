<?php
/* Smarty version 4.5.5, created on 2025-07-27 13:01:43
  from 'app:controllersgridsettingsuserformuserRoleForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68861527b970a6_27596448',
...
function content_68861527b970a6_27596448 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
<?php echo '</script'; ?>
>
<form class="pkp_form" id="userRoleForm" method="post" action="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>PKP\core\PKPApplication::ROUTE_COMPONENT,'component'=>"grid.settings.user.UserGridHandler",'op'=>"updateUserRoles"),$_smarty_tpl ) );?>
">
...
$_block_repeat=true;
echo $_block_plugin2(array('list'=>true,'title'=>"grid.user.userRoles"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				<?php
...
echo $_block_plugin2(array('list'=>true,'title'=>"grid.user.userRoles"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin4(array('list'=>true,'title'=>"grid.user.userRoles.masthead"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				<?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			<?php $_block_repeat=false;
echo $_block_plugin4(array('list'=>true,'title'=>"grid.user.userRoles.masthead"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php $_block_repeat=false;
