<?php
/* Smarty version 4.5.5, created on 2025-07-27 12:59:08
  from 'app:controllersgridsettingsuseruserGridFilter.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_6886148c746385_39043727',
...
function content_6886148c746385_39043727 (Smarty_Internal_Template $_smarty_tpl) {
...
$_block_repeat=true;
echo $_block_plugin2(array('title'=>"common.search",'for'=>"search"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo $_block_plugin2(array('title'=>"common.search",'for'=>"search"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin3(array('list'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_smarty_tpl->_assignInScope('checked', "checked");
		...
		<?php $_block_repeat=false;
echo $_block_plugin3(array('list'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
