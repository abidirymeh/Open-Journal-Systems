<?php
/* Smarty version 4.5.5, created on 2025-07-27 13:02:44
  from 'app:userloginChangePassword.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_688615641d88c2_63177445',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fa4c6a547db893633e6e2b3662a527e739f9957d' => 
    array (
      0 => 'app:userloginChangePassword.tpl',
      1 => 1752100232,
      2 => 'app',
    ),
  ),
...
function content_688615641d88c2_63177445 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1413173278688615641a6c65_33471098', "page");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "layouts/backend.tpl");
}
/* {block "page"} */
class Block_1413173278688615641a6c65_33471098 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page' => 
  array (
    0 => 'Block_1413173278688615641a6c65_33471098',
  ),
);
...
$_block_repeat=true;
echo $_block_plugin1(array('id'=>"loginFields"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin2(array('label'=>"user.login",'for'=>"username"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo $_block_plugin2(array('label'=>"user.login",'for'=>"username"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin3(array('label'=>"user.profile.oldPassword",'for'=>"oldPassword"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin3(array('label'=>"user.profile.oldPassword",'for'=>"oldPassword"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin4(array('label'=>"user.profile.newPassword",'for'=>"password"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin4(array('label'=>"user.profile.newPassword",'for'=>"password"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin5(array('label'=>"user.profile.repeatNewPassword",'for'=>"password2"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin5(array('label'=>"user.profile.repeatNewPassword",'for'=>"password2"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin1(array('id'=>"loginFields"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		</form>
	</div>
