<?php
/* Smarty version 4.5.5, created on 2025-07-27 12:57:33
  from 'app:usercontactForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_6886142d73a312_78407313',
...
function content_6886142d73a312_78407313 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
	$(function() {
...
while ($_block_repeat) {
ob_start();?>
		<?php if ($_smarty_tpl->tpl_vars['changeEmailPending']->value) {?>
			<p>
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"hidden",'id'=>"pendingEmail",'value'=>$_smarty_tpl->tpl_vars['changeEmailPending']->value),$_smarty_tpl ) );?>

				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"user.pendingEmailChange",'pendingEmail'=>$_smarty_tpl->tpl_vars['changeEmailPending']->value),$_smarty_tpl ) );?>

				<button type="submit" class="pkp_button" name="action" value="cancelPendingEmail"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"common.cancel"),$_smarty_tpl ) );?>
</button>
			</p>
		<?php }?>
		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"email",'readonly'=>(($tmp = $_smarty_tpl->tpl_vars['changeEmailPending']->value ?? null)===null||$tmp==='' ? false ?? null : $tmp),'label'=>"user.email",'id'=>"email",'value'=>$_smarty_tpl->tpl_vars['email']->value,'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['MEDIUM'],'required'=>true),$_smarty_tpl ) );?>

		
		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"email",'label'=>"Email privé 1",'id'=>"email_private_1",'name'=>"email_private_1",'value'=>$_smarty_tpl->tpl_vars['email_private_1']->value,'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['MEDIUM']),$_smarty_tpl ) );?>

		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"email",'label'=>"Email privé 2",'id'=>"email_private_2",'name'=>"email_private_2",'value'=>$_smarty_tpl->tpl_vars['email_private_2']->value,'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['MEDIUM']),$_smarty_tpl ) );?>
...
$_block_repeat=true;
echo $_block_plugin3(array('title'=>"user.workingLanguages",'list'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			<?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		<?php $_block_repeat=false;
echo $_block_plugin3(array('title'=>"user.workingLanguages",'list'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }?>
