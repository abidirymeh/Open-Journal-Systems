...
$templateMgr = PKPTemplateManager::getManager($request);
    ...
    $this->setupTemplate($request);
        ...
        $templateMgr->assign([
            'emailPrivate1' => $user->getData('email_private_1'),
            'emailPrivate2' => $user->getData('email_private_2'),
        ]);
    ...
    public function saveContact($args, $request)
    {
        ...
        $user->setData('email_private_1', $request->getUserVar('emailPrivate1'));
        $user->setData('email_private_2', $request->getUserVar('emailPrivate2'));
